...
const Login = () => {
  ...
  const validate = () => {
    const obj = {};
    obj.email = value.email ? "" : "Please enter your email";
    obj.psw = value.psw ? "" : "Enter a password to login";
    setErr(obj);
        ...
        <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
          ...
          <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
            <form>
              ...
              <span className="text-red-500 text-xs italic my-4">
                {err ? err.email || err.psw : ""}
              </span>
              <span className="text-green-500 text-sm italic my-4 text-center">
                {msg1 && msg1}
              </span>
              <span className="text-red-500 text-xs italic my-4">
                {msg && msg}
